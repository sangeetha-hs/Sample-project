async function postUser(obj){
    try{
      let response = await axios.post("https://crudcrud.com/api/63db16c642904dd28f803fa429565015/seller",obj);
  ...
  try{
    ...
    let response = await axios.get("https://crudcrud.com/api/63db16c642904dd28f803fa429565015/seller")
    console.log(response);
  ...
  async function deleteUser(data2){
    try{
      let response = await axios.delete(`https://crudcrud.com/api/63db16c642904dd28f803fa429565015/seller/${data2}`);
